  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 pt-[90px]">
      <div className="mb-6 flex items-center gap-3 max-w-7xl mx-auto">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Databasöversikt</h1>
          <p className="text-sm text-muted-foreground">Hantera och sök i databasen</p>
        </div>
      </div>
      <div className="rounded-xl border bg-card p-6 sm:p-8 text-center max-w-7xl mx-auto">
        <p className="text-muted-foreground">Databasvy kommer snart...</p>
      </div>
    </div>
  );
};
